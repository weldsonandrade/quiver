...
namespace Quiver.Models
{
    ...
    {
        [Required]
        [StringLength(100, ErrorMessage = "O {0} deve ter pelo menos dois caracteres {2}.", MinimumLength = 6)]
    ...
    public class ChangePasswordViewModel
    {
        ...
        [Required]
        [StringLength(100, ErrorMessage = "A {0} deve ter pelo menos {2} de tamanho.", MinimumLength = 6)]
        [DataType(DataType.Password)]
