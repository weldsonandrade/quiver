...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.defaults = {
        ...
        labels: {
            all: "Todos",
            infos: "Total de {{ctx.total}} registro(s) gravado(s)",
            loading: "Carregando...",
        ...
        templates: {
            ...
            actionDropDownCheckboxItem: "<li><div class=\"checkbox\"><label class=\"{{css.dropDownItem}}  dp-{{ctx.label}}\" ><input name=\"{{ctx.name}}\" type=\"checkbox\" value=\"1\" class=\"{{css.dropDownItemCheckbox}}\" {{ctx.checked}} /><i class=\"input-helper\"></i> {{ctx.label}}</label></div></li>",
